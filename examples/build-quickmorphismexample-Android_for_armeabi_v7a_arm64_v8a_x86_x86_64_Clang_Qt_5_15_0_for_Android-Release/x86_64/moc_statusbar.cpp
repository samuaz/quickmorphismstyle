...
QT_MOC_LITERAL(1, 10, 9), // "available"
QT_MOC_LITERAL(2, 20, 14), // "statusBarColor"
QT_MOC_LITERAL(3, 35, 11), // "navBarColor"
QT_MOC_LITERAL(4, 47, 5), // "theme"
QT_MOC_LITERAL(5, 53, 5), // "Theme"
QT_MOC_LITERAL(6, 59, 5), // "Light"
QT_MOC_LITERAL(7, 65, 4) // "Dark"

    },
    "StatusBar\0available\0statusBarColor\0"
    "navBarColor\0theme\0Theme\0Light\0Dark"
};
...
static const uint qt_meta_data_StatusBar[] = {
 ...
 // enum data: key, value
       6, uint(StatusBar::Light),
       7, uint(StatusBar::Dark),
...
void StatusBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 1: *reinterpret_cast< QColor*>(_v) = _t->statusBarColor(); break;
        case 2: *reinterpret_cast< QColor*>(_v) = _t->navBarColor(); break;
        case 3: *reinterpret_cast< Theme*>(_v) = _t->theme(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 1: _t->setStatusBarColor(*reinterpret_cast< QColor*>(_v)); break;
        case 2: _t->setNavBarColor(*reinterpret_cast< QColor*>(_v)); break;
        case 3: _t->setTheme(*reinterpret_cast< Theme*>(_v)); break;
        default: break;
        }
